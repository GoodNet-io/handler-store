# Standalone Nix derivation for the goodnet-handler-store plugin.
...
# nlohmann_json). Build artefacts: `lib<goodnet_handler_store>.so`
...
stdenv.mkDerivation {
  ...
  meta = {
    description = "GoodNet plugin: goodnet-handler-store";
